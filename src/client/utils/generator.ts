import { ChannelTypes, DiscordChannel, DiscordInteraction, InteractionTypes } from '@discordeno/types'

import type { AnyChannel } from '../typings'
...
export function generateChannel(data: DiscordChannel, client: Client): AnyChannel {
  switch (data.type) {
...
export function generateInteraction(data: DiscordInteraction, client: Client) {
    switch (data.type) {
